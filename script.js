function _extends() {_extends = Object.assign || function (target) {for (var i = 1; i < arguments.length; i++) {var source = arguments[i];for (var key in source) {if (Object.prototype.hasOwnProperty.call(source, key)) {target[key] = source[key];}}}return target;};return _extends.apply(this, arguments);}function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}console.clear();
...
class Synth {
  ...
  constructor(params = {}) {_defineProperty(this, "getAnalyserData",
    ...
    });_defineProperty(this, "getUnisonWidth",

    amt => amt * Synth.MAX_UNISON_WIDTH);_defineProperty(this, "calcFreqValue",

    amt => Math.max(Synth.MIN_FILTER_FREQ, amt * (Synth.AC.sampleRate / 2)));_defineProperty(this, "getADSRTarget",
    ...
    () => {
      ...
      this.noteOff();
    });if (!Synth.AC) throw 'Synth: Web Audio not supported!';console.log('New Synth', Synth.AC.currentTime);this.oscillators = new Array(3);this.params = { ...Synth.PARAM_DEFAULTS, ...params };this.nodes = {};this.nodes.volume = Synth.AC.createGain();this.setParam('volume');this.nodes.adsr = Synth.AC.createGain();this.nodes.filter = Synth.AC.createBiquadFilter();this.nodes.filter.type = 'lowpass';this.setParam('filterFreq');this.setParam('filterQ');this.nodes.delay = Synth.AC.createDelay(Synth.MAX_ECHO_DURATION);this.nodes.feedback = Synth.AC.createGain();this.setParam('echoTime');this.setParam('echoFeedback');this.nodes.analyser = Synth.AC.createAnalyser();this.nodes.analyser.smoothingTimeConstant = 0.5;this.nodes.analyser.fftSize = 256;this.analyserBufferLength = this.nodes.analyser.frequencyBinCount;this.analyserData = new Uint8Array(this.analyserBufferLength);this.nodes.adsr.connect(this.nodes.filter);this.nodes.filter.connect(this.nodes.delay);this.nodes.delay.connect(this.nodes.feedback);this.nodes.feedback.connect(this.nodes.delay);this.nodes.filter.connect(this.nodes.volume);this.nodes.feedback.connect(this.nodes.volume);this.nodes.volume.connect(this.nodes.analyser);this.nodes.analyser.connect(Synth.AC.destination);this.sequence = ['C-3', 'D#3', 'G-3', 'C-3', 'D-3', 'D#3', 'C-3', 'D-3', 'D#3', 'C-3', 'D#3', 'G#3', 'C-3', 'G-3', 'C-3', 'G-3'];this.isPlaying = false;}}



/** UI **/_defineProperty(Synth, "AC", new (AudioContext || webkitAudioContext)());_defineProperty(Synth, "TYPES", ['sine', 'square', 'triangle', 'sawtooth']);_defineProperty(Synth, "TYPES_ABBR", ['sin', 'squ', 'tri', 'saw']);_defineProperty(Synth, "ADSR_TARGETS", ['adsr', 'filter']);_defineProperty(Synth, "MAX_UNISON_WIDTH", 30);_defineProperty(Synth, "MAX_ADSR_STAGE_DURATION", 2);_defineProperty(Synth, "MAX_ECHO_DURATION", 2);_defineProperty(Synth, "MIN_FILTER_FREQ", 40);_defineProperty(Synth, "MAX_FILTER_Q", 30);_defineProperty(Synth, "PARAM_DEFAULTS", { unisonWidth: 0.2, volume: 0.3, adsrAttack: 0.2, adsrDecay: 0, adsrSustain: 1, adsrRelease: 0.2, adsrTarget: 0, filterFreq: 0.5, filterQ: 0.2, echoTime: 0, echoFeedback: 0, waveform: 3 });
...
const SequencerStateProvider = ({ children }) => {
  ...
  return /*#__PURE__*/(
    React.createElement(SequencerStateContext.Provider, { value: reducer },
    children));
...
const ControlGroup = ({ label, children, className }) => /*#__PURE__*/
React.createElement("fieldset", { className: className }, /*#__PURE__*/
...
const GenericSlider = ({ label, belowLabel, ...options }) => {
  return /*#__PURE__*/(
    React.createElement("label", { className: "generic-slider" },
    label && /*#__PURE__*/React.createElement("span", { class: "sidelabel" }, label), /*#__PURE__*/
    React.createElement("div", null, /*#__PURE__*/
    React.createElement("input", _extends({ type: "range", min: "0", max: "1", step: "0.01" }, options)),
    belowLabel && /*#__PURE__*/React.createElement("span", { class: "sublabel" }, belowLabel))));
...
const PotSlider = ({ param, label, belowLabel }) => {
  ...
  return /*#__PURE__*/(
    React.createElement(GenericSlider, { label: label, value: val, onInput: setVal }));
  ...
  const renderKeys = () => notes.map(note => {
    ...
    return /*#__PURE__*/(
      React.createElement("button", {
        ...
        onMouseUp: synth.noteOff }, /*#__PURE__*/
...
const PlayButton = () => {
  ...
  return /*#__PURE__*/(
    React.createElement(ActionButton, { label: "Play/Stop", className: cn, onClick: startSequencer }));
...
const EditButton = () => {
  ...
  return /*#__PURE__*/(
    React.createElement(ActionButton, { label: "Edit", className: cn, onClick: toggleEdit }));
...
const RestButton = () => {
  ...
  return /*#__PURE__*/(
    React.createElement(ActionButton, { label: "Rest", onClick: addRest }));
...
const ClearButton = () => {
  ...
  return /*#__PURE__*/(
    React.createElement(ActionButton, { label: "Clear", className: "clear" }));
...
const Sequencer = () => {
  ...
  return /*#__PURE__*/(
    React.createElement("div", { className: "sequencer" }, /*#__PURE__*/
    React.createElement("div", { className: "sequencer-row" },
    renderSteps(0, 8)), /*#__PURE__*/
...
const Visualizer = () => {
  ...
  return /*#__PURE__*/(
    React.createElement("canvas", { className: "visualizer", width: "128", height: "45", ref: canvasRef }));

};

const SynthUI = ({ synth, label, keyboardNotes }) => /*#__PURE__*/
React.createElement(SequencerStateProvider, null, /*#__PURE__*/
React.createElement(SynthContext.Provider, { value: synth }, /*#__PURE__*/
React.createElement("section", null, /*#__PURE__*/
React.createElement("div", { className: "row" }, /*#__PURE__*/
React.createElement(ControlGroup, { label: "Visualizer", className: "cg-visualizer" }, /*#__PURE__*/
React.createElement(Visualizer, null))), /*#__PURE__*/



React.createElement("div", { className: "row" }, /*#__PURE__*/
React.createElement(ControlGroup, { label: "Sequencer", className: "cg-sequencer" }, /*#__PURE__*/
React.createElement("div", { className: "row" }, /*#__PURE__*/
React.createElement("div", { className: "row sequencer-controls" }, /*#__PURE__*/
React.createElement("div", { className: "col-sequencer-controls" }, /*#__PURE__*/
React.createElement(PlayButton, null), /*#__PURE__*/
React.createElement(ClearButton, null), /*#__PURE__*/
React.createElement(EditButton, null), /*#__PURE__*/
React.createElement(RestButton, null)))))), /*#__PURE__*/
...
React.createElement("div", { className: "row" }, /*#__PURE__*/
React.createElement("div", { className: "col w-col" }, /*#__PURE__*/
React.createElement(ControlGroup, { label: "Master" }, /*#__PURE__*/
React.createElement(PotSlider, { param: "volume", label: "Vol" })), /*#__PURE__*/


React.createElement(ControlGroup, { label: "Voicing" }, /*#__PURE__*/
React.createElement(SwitchSlider, { param: "waveform", label: "WAV", belowLabels: Synth.TYPES_ABBR }), /*#__PURE__*/
React.createElement(PotSlider, { param: "unisonWidth", label: "WID" }))), /*#__PURE__*/



React.createElement(ControlGroup, { label: "ADSR", className: "cg-adsr" }, /*#__PURE__*/
React.createElement(SwitchSlider, { param: "adsrTarget", label: "FILTER", belowLabels: ['', '', '', ''] }), /*#__PURE__*/
React.createElement(PotSlider, { param: "adsrDecay", label: "DECAY" }), /*#__PURE__*/
React.createElement(PotSlider, { param: "adsrSustain", label: "SUSTAIN" }), /*#__PURE__*/
React.createElement(PotSlider, { param: "adsrRelease", label: "RELEASE" }), /*#__PURE__*/
React.createElement(PotSlider, { param: "adsrAttack", label: "ATTACK" })), /*#__PURE__*/


React.createElement("div", { className: "col w-col" }, /*#__PURE__*/
React.createElement(ControlGroup, { label: "Filter" }, /*#__PURE__*/
React.createElement(PotSlider, { param: "filterFreq", label: "FRQ" }), /*#__PURE__*/
React.createElement(PotSlider, { param: "filterQ", label: "Q" })), /*#__PURE__*/


React.createElement(ControlGroup, { label: "Echo FX" }, /*#__PURE__*/
React.createElement(PotSlider, { param: "echoTime", label: "TIM" }), /*#__PURE__*/
React.createElement(PotSlider, { param: "echoFeedback", label: "FBK" })))))));
...
const App = () => {
  ...
  return /*#__PURE__*/(
    React.createElement("div", { id: "demo", className: "slide-basic" }, /*#__PURE__*/
    React.createElement(SynthUI, { synth: synth })));
